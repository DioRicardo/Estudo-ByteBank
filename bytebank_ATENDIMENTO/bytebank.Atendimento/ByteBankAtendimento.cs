...
internal class ByteBankAtendimento
{
    ...
    void PesquisarContas()
    {
        ...
        Console.Write("Deseja pesquisar por (1) NUMERO DA CONTA, (2) CPF TITULAR ou (3) NÚMERO DA AGÊNCIA ? ");
            ...
            case 3:
                {
                    ...
                    List<ContaCorrente> contasPorAgencia = ConsultaPorNumeroAgencia(_numeroAgencia);
    ...
    ContaCorrente ConsultaPorNumeroConta(string? numeroConta)
    {
        ...
        //Utilizando a sintaxe de Consulta LINQ.
    ...
    {
        //return _listaDeContas.FindAll(conta => conta.Numero_agencia.Equals(numeroAgencia)).ToList();
    ...
    void ExibirListaDeContas(List<ContaCorrente> contasPorAgencia)
    {
        ...
        {
            foreach (ContaCorrente conta in contasPorAgencia)
            {
